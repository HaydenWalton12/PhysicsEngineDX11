...
public:
	...
	//We Can see the utility of overloading operator being used.Overload operators are functions with special names , utilising the keyword
	//"operator" followed by the symbol of the operator being defined 
	//From this , based upon the operator (arthmatic for example) being used, we can express the mathmatics followed upon the arthmatic symbol
	//being used in the overloading operators. E.G "operator +(const vec2 &rhs) " will add to the sum of the vector being passed in with the vector
	//variable defined from this class.

	//This entire class allows us to create a "vec" variable assigned to a class, upon doing so each of the functions allow us to pass in new other vectors
	//which we can apply mathmatical calculations too.
